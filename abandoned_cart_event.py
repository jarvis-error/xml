    ...
    soap_message = '''<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="urn:nms:rtEvent">
                        ...
                        <soapenv:Body>
                            <urn:PushEvent>
                                ...
                                <urn:domEvent>
                                    <rtEvent email="kirti.p@anxilla.com" type="abandoned_cart_event" wishedChannel="0">
                                        <ctx>
                                            <bookingReferenceID>#ABC456</bookingReferenceID>
                                            <supportURL>https://www.malaysiaairlines.com/hq/en/help/contact-us.html</supportURL>
                                            <flights>
                                                <flight>
